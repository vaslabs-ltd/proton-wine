...
static void dump_send_socket_reply( const struct send_socket_reply *req )
{
    fprintf( stderr, " wait=%04x", req->wait );
    fprintf( stderr, ", options=%08x", req->options );
    fprintf( stderr, ", fixup_type=%d", req->fixup_type );
}

static void dump_socket_fixup_send_data_request( const struct socket_fixup_send_data_request *req )
{
    fprintf( stderr, " handle=%04x", req->handle );
...
static void dump_socket_get_fixup_data_request( const struct socket_get_fixup_data_request *req )
{
    fprintf( stderr, " handle=%04x", req->handle );
    fprintf( stderr, ", icmp_seq=%04x", req->icmp_seq );
}

static void dump_socket_get_fixup_data_reply( const struct socket_get_fixup_data_reply *req )
{
    fprintf( stderr, " icmp_id=%04x", req->icmp_id );
}
...
static const dump_func req_dumpers[REQ_NB_REQUESTS] = {
    ...
    (dump_func)dump_socket_fixup_send_data_request,
    (dump_func)dump_socket_get_fixup_data_request,
...
static const dump_func reply_dumpers[REQ_NB_REQUESTS] = {
    ...
    NULL,
    (dump_func)dump_socket_get_fixup_data_reply,
...
static const char * const req_names[REQ_NB_REQUESTS] = {
    ...
    "recv_socket",
    "send_socket",
    "socket_fixup_send_data",
    "socket_get_fixup_data",
