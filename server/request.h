...
static const req_handler req_handlers[REQ_NB_REQUESTS] =
{
    ...
    (req_handler)req_socket_fixup_send_data,
    (req_handler)req_socket_get_fixup_data,
...
C_ASSERT( FIELD_OFFSET(struct send_socket_reply, fixup_type) == 16 );
C_ASSERT( sizeof(struct send_socket_reply) == 24 );
C_ASSERT( FIELD_OFFSET(struct socket_fixup_send_data_request, handle) == 12 );
C_ASSERT( FIELD_OFFSET(struct socket_fixup_send_data_request, icmp_id) == 16 );
C_ASSERT( FIELD_OFFSET(struct socket_fixup_send_data_request, icmp_seq) == 18 );
C_ASSERT( sizeof(struct socket_fixup_send_data_request) == 24 );
C_ASSERT( sizeof(struct socket_fixup_send_data_reply) == 8 );
C_ASSERT( FIELD_OFFSET(struct socket_get_fixup_data_request, handle) == 12 );
C_ASSERT( FIELD_OFFSET(struct socket_get_fixup_data_request, icmp_seq) == 16 );
C_ASSERT( sizeof(struct socket_get_fixup_data_request) == 24 );
C_ASSERT( FIELD_OFFSET(struct socket_get_fixup_data_reply, icmp_id) == 8 );
C_ASSERT( sizeof(struct socket_get_fixup_data_reply) == 16 );
